...
static int pruebasterminadas = 0;
	...
	@Test
	void PruebaFuncion3() {
        assertEquals(30, Funciones3.Funciones3(new int[] {9, 10, 11})); 
	...
	void Prueba2Funcion3() {
        assertEquals(9, Funciones3.Funciones3(new int[] {9, 8, 7}));
	...
	void Prueba3Funcion3() {
        assertEquals(51, Funciones3.Funciones3(new int[] {18, 17, 16}));
	...
	void Prueba4Funcion3() {
        assertEquals(18, Funciones3.Funciones3(new int[] {18, 25, 26}));
	...
	void Prueba5Funcion3() {
        assertEquals(34, Funciones3.Funciones3(new int[] {9, 14, 11}));
	...
	void Prueba6Funcion3() {
        assertEquals(0, Funciones3.Funciones3(new int[] {4, 2, 20}));
	...
	void Prueba7Funcion3() {
        assertEquals(15, Funciones3.Funciones3(new int[] {2, 15, 40}));
	...
	void Prueba8Funcion3() {
        assertEquals(0, Funciones3.Funciones3(new int[] {0, 0, 0}));
