...
class PruebasFunciones2 {
	...
	void PruebaFuncion2(){
		assertNull(null, Funciones2.Funcion2("Limon", "Limon")); 
	...
	void Prueba1Funcion2() {
		assertEquals("Limonxelo", Funciones2.Funcion2("Limonxelo", "Limon")); //
	...
	void Prueba3Funcion2() {
		assertEquals("Limonxelo", Funciones2.Funcion2("Limon", "Limonxelo")); //
	...
	void Prueba4Funcion2() {
		assertEquals(null, Funciones2.Funcion2(" ", " ")); //
	...
	void Prueba5Funcion2() {
		assertEquals(null, Funciones2.Funcion2("Illo", "Illo")); //
	...
	void Prueba8Funcion1() {
		assertEquals("Hola soy pepito el de los palotes", Funciones2.Funcion2("adios", "Hola soy pepito el de los palotes"));
