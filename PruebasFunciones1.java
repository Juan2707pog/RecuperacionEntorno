...
class PruebasFunciones1 {
	...
	void PruebaFuncion1(){
		assertEquals(true, Funciones.Funcion1("eeeeeeeeeeeeeeeeee")); // Hay 18 e por lo tanto sería true 
	}
	
	@Test
	@DisplayName("Caja negra con valores limites inferior -1")
	void Prueba2Funcion1(){
		assertEquals(false, Funciones.Funcion1("ooooooooooooooooo")); // Hay 17 o por lo tanto sería false
	}
	...
	void Prueba5Funcion1() {
		assertEquals(false, Funciones.Funcion1("Limonxelo de todos los santos")); // Cuenta como valor válido ya que si son letras, aunque salga false es valido
	}
	...
	void Prueba6Funcion1() {
		assertEquals(true, Funciones.Funcion1("Mi campeón favorito, sin duda alguna Anivia, la criofenix. No tendrá mucho ataque, no tendrá mucha defensa... pero me encanta."));
