...
static int pruebasterminadas = 0;
	...
	@Test
	void PruebaFuncion4() {
		assertEquals("Insuficiente", Funciones4.funcion4( new int[] {4, 4, 4, 4, 3}));
	...
	void Prueba2Funcion4() {
		assertNotEquals("Suficiente", Funciones4.funcion4( new int[] {4, 4, 4, 4, 3}));
	...
	void Prueba3Funcion4() {
		assertEquals("Notable", Funciones4.funcion4( new int[] {7, 7, 7, 7}));
	...
	void Prueba4Funcion4() {
		assertEquals("Bien", Funciones4.funcion4( new int[] {6, 6, 6, 6, 6}));
	...
	void Prueba5Funcion4() {
		assertEquals("Suficiente", Funciones4.funcion4( new int[] {9, 8, 5, 2, 1}));
	...
	void Prueba6Funcion4() {
		assertEquals("Notable", Funciones4.funcion4( new int[] {7, 7, 8, 7, 8}));
	...
	void Prueba7Funcion4() {
		assertEquals("Insuficiente", Funciones4.funcion4( new int[] {0, 0}));
	...
	void Prueba8Funcion4() {
		assertEquals("Notable", Funciones4.funcion4( new int[] {7}));
